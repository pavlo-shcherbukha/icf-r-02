/**
  ...
  * @see https://cloud.ibm.com/apidocs/cloudant?code=node#postdocument
  * 
...
function main(params) {
    ...
    return createDoc(service,params.dbname, params.doc )
    .then( body => {
...
function createDoc(cloudant, dbName, doc) {

    return new Promise(function (resolve, reject) {
        var l_cmd = { db: dbName,  document: doc };
        cloudant.postDocument( l_cmd )
        .then ( resp => {
