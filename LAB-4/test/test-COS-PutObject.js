...
describe(' Local test IBM Cloud Functions ', function() {
  ...
  it('function COS-PutObject:' + ' Expect COS put object into bucket', function(done){

    var vfunc = require('../src/COS-PutObject');
    var vprm = require('../params/COS-PutObject.json');
